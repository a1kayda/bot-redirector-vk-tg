...
def initConfig():
    ...
    setCell( "vk_album_id", 282210957 ) # ID альбома, куда будут заливаться стикеры из тележки
    ...
    #setCell( "vk_c547", '-794935891' ) # Пример переадресации из чата ВК в Telegram
    #setCell( "t_-794935891", 'c547' ) # Пример переадресации из чата ВК в Telegram
